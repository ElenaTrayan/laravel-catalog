        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        <a href="{{ route('admin.index') }}"><i class="fa fa-th-large"></i> <span class="nav-label">Главная</span></a>
                    </li>
                    <li>
                        <a href="{{ route('admin.products.index') }}"><i class="fa fa-diamond"></i> <span class="nav-label">Товары</span>
                            <span class="label label-warning pull-right">
                                @if($countProducts = \App\Models\Product::count())
                                    <span>{{ $countProducts }}</span>
                                @endif
                            </span></a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-diamond"></i> <span class="nav-label">Торговые марки</span></a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-diamond"></i> <span class="nav-label">Поставщики</span></a>
                    </li>
                    <li class="">
                        <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Пункт меню</span> <span class="fa arrow"></span></a>
                    </li>
                </ul>
...
<!-- ChartJS-->
<script src="{{ asset('backend/js/plugins/chartbackend/js/Chart.min.js') }}"></script>
